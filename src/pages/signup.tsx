			...
			<div className='flex flex-col w-full h-full justify-center items-center'>
				<div className='flex flex-col items-center bg-white p-20 rounded-xl gap-10 shadow-[2px_3px_30px_10px_rgba(0,0,0,0.2)]'>
					...
					<div className='flex flex-col items-center justify-center gap-4 w-full'>
						<button className='w-full bg-primary py-3 px-16 rounded-xl text-white font-bold shadow-[2px_4px_6px_0px_rgba(0,0,0,0.25)] hover:bg-[#8CB4FF]' onClick={signupHandler}>
							Sign up
						</button>
